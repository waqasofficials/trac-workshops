...
const char* password = "waqas423";

// Set web server port number to 3306
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            // Web Page Heading
            client.println("<body><h1>Home Automation System Using Local Host</h1>");
            ...
            client.println("<p>LIGHT 4 " + output13State + "</p>");
